...
%token tPRIVATE tPUBLIC tIMPORT
%token tAND tOR tSIZEOF tRETURN tARROW tTHEN
...
vardec       :   data_type '?'  tIDENTIFIER                                { $$ = new fir::variable_declaration_node(LINE, $1, tIMPORT, *$3, nullptr); }
...
funcDeclaration: data_type     tIDENTIFIER '(' argdecs ')'                 { $$ = new fir::function_declaration_node(LINE, $1, tPRIVATE, *$2, $4); }
               | data_type '?' tIDENTIFIER '(' argdecs ')'                 { $$ = new fir::function_declaration_node(LINE, $1, tIMPORT,  *$3, $5); }
               ...
               | void_type '?' tIDENTIFIER '(' argdecs ')'                 { $$ = new fir::function_declaration_node(LINE, $1, tIMPORT, *$3, $5); }
...
lval : tIDENTIFIER                                                         { $$ = new cdk::variable_node(LINE, *$1); delete $1;}
     ...
     | tIDENTIFIER '(' expressions ')' '[' expr ']'                        { $$ = new fir::index_node(LINE, new fir::function_call_node(LINE, *$1, $3), $6); delete $1; }
     | tIDENTIFIER '(' ')' '[' expr ']'                                    { $$ = new fir::index_node(LINE, new fir::function_call_node(LINE, *$1, nullptr), $5); delete $1; }
     ;
